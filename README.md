...
| Ridge | 1073.3268 | 0.2358 | Линейная модель хуже справляется с нелинейной структурой спроса, хуже baseline |
| KNN | 1113.8493 | 0.1770 | Худший результат среди протестированных моделей, даже baseline |
